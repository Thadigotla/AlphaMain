        ...
        <div className="form_left">
          ...
          >
            ...
            <div className="form_field_wrapper">
              <Form.Item
                label="Email Address"
                className="form_field_wrapper_label"
              >
                <Input className="form_field_wrapper_input" />
              </Form.Item>
            </div>
      ...
      <section className="footer">
        <div className="footer_left">
          ...
          <div className="footer_left_address">
            <div className="footer_left_address_one">
              Be11a Js House, Ironmongers Mews,
            </div>
            <div className="footer_left_address_two">
              Church Road, Barnes, London, England,
            </div>
  ...
  <span></span>
        ...
        <div className="footer_right">
          ...
          <div className="footer_right_input">
            <form
              className="footer_right_input_form"
              id="email-form"
              name="email-form"
            ...
            >
              <input
                className="footer_right_input_form_input"
                type="email"
                name="email-2"
                data-name="Email 2"
              ...
              />
              <input
                className="footer_right_input_form_button"
                type="submit"
                value="Send"
